...
public class LogManager {
	...
	public synchronized void recordUpdate( String strTransID, 
	 ...
	 Object objOld, 
	 Object objNew){
		String line = "<"+strTransID+", "+page.toString()+"_"+strKeyValue+", "+
	...
	public synchronized void recordInsert(String strTransID, 
	 ...
	 Hashtable<String,String> htblColValues){
		...
		values+="]";
		String line = "<Insert, "+strTransID+", "+page.toString()+", "+ values+">";
		log.add(line);
	}
	...
	public synchronized void recordDelete(String strTransID, 
	 ...
	 Hashtable<String,String> htblColValues){
		...
		values+="]";
		String line = "<delete, "+strTransID+", "+page.toString()+"_"+strKeyValue+", "+ values+">";
		log.add(line);
	}
